...
let longit = iss_location.iss_position.longitude
console.log("The longtitude is", longit)
...
let exchangeEuro = rates.AUD
let AUDValue = exchangeEuro * 100
console.log("The equivalent value of 100 Euros in Australian Dollars is", AUDValue)
// TODO write code to identify the currency symbol that has the highest exchange rate compared to Euros.
//    In other words, identify the property with the largest value. the answer is BRL (Brazilian Real) at 3.8959 BRL to 1 Euro.
console.log("he highest exchange rate compared to Euros is the Brazilian Real and the rate is",rates.BRL)
